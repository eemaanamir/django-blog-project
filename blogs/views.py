...
def index_view(request):
    return render(request, "blogs/home.html", {"blog_list": blog_list[:6], "current_user": author, "home_featured_blogs": blog_list[:5]})


def blog_list_view(request):
    return render(request, "blogs/bloglist.html", {"blog_list": blog_list, "list_heading": 'Subscriptions', "current_user": author, 'featured_blog_list': blog_list[:3]})


def single_blog_view(request, blog_id):
    return render(request, "blogs/single.html", {"blog": blog, "comment_list": comment_list, 'author': author, 'featured_blog_list': blog_list[:3], "current_user": author})


def user_profile_view(request, user_id):
    return render(request, "blogs/user_profile.html", {"blog_list": blog_list[:6], 'user': author, "current_user": author})
...
def sub_plans_view(request):
    return render(request, "blogs/subscription_plans.html", {"premium_price": 'Rs. 1.5k', "ultra_price": 'Rs. 14k', "current_user": author})


def edit_profile_view(request):
    return render(request, "blogs/edit_profile.html", {"current_user": author})
...
def list_drafts_and_published(request, list_type):
    ...
    return render(request, "blogs/my_drafts_and_published_list.html", {"current_user": author, "blog_list": blog_list, "list_heading": list_type.upper})
